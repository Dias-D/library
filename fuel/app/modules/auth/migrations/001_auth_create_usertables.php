        ...
        if (in_array('Simpleauth', $drivers)) {
            ...
            if (!\DBUtil::table_exists($table)) {
                ...
                \DBUtil::create_table($table, array(
                    ...
                    'social_security' => array('type' => 'varchar', 'constraint' => 12),
                ...
                \DBUtil::create_index($table, array('username'), 'username', 'UNIQUE');
                \DBUtil::create_index($table, array('email'), 'email', 'UNIQUE');
            }
        } elseif (in_array('Ormauth', $drivers) || in_array('Dasauth', $drivers)) {
            // get the tablename
