...
function AwesomeChart(canvasElementId){
    ...
    this.chartPointFillStyle = '#333';
    
    this.chartLineStrokeStyle = '#333';
    this.chartLineWidth = 2;
    
    this.barFillStyle = 'rgb(95,159,159)';
    this.barStrokeStyle = '#fff';
    this.barBorderWidth = 2.0;
    this.barShadowColor = 'rgba(0, 0, 0, 0)';
    this.barShadowBlur = 0;
    this.barShadowOffsetX = 0;
