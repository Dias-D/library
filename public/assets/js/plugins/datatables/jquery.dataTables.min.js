...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": ativar para classificar a coluna ascendente",sSortDescending:": ativar para classificar a coluna descendente"},oPaginate:{sFirst:"Primeiro",sLast:"Último",
sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados disponíveis na tabela",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 a 0 de 0 entradas",sInfoFiltered:"(filtrado do _MAX_ total de entradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ de entradas",sLoadingRecords:"Carregando...",sProcessing:"Em processamento...",sSearch:"Pesquisar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
